...
| Evaluation Benchmark | Benchmark Size | Prior SOTA (Qwen3-8B SFT v2) | Nemotron BPF-Guardian SFT v1 | Nemotron BPF-Guardian RL (Solve@2) | Relative Improvement |
|---|---:|---:|---:|---:|---:|
| **Protected Private Synthesis** | 120 tasks | 31 / 120 (25.8%) | 54 / 120 (45.0%) | **59 / 120 (49.2%)** | **+90.3%** |
| **Protected Standalone Repair** | 120 tasks | 85 / 120 (70.8%) | **91 / 120 (75.8%)** | 91 / 120 (75.8%) | **+7.1%** |
| **Combined Protected Suite** | 276 tasks | 137 / 276 (49.6%) | **168 / 276 (60.9%)** | **172 / 276 (62.3%)** | **+25.6%** |
| **Confirmation Suite** | 60 tasks | 33 / 60 (55.0%) | 42 / 60 (70.0%) | **44 / 60 (73.3%)** | **+33.3%** |

*All results verified with zero mock verifiers using `clang-18 -target bpf -O2` and kernel execution on Linux 6.8.*

## Available Checkpoints & Branches

- **`main`**: SFT v1 Champion checkpoint (optimized for standalone synthesis and repair, 75.8% repair pass rate).
- **`rl-n3`**: Multi-turn diagnostic-guided repair RLVR checkpoint (optimized for two-turn interactive repair with compiler/verifier feedback, 49.2% Solve@2).
