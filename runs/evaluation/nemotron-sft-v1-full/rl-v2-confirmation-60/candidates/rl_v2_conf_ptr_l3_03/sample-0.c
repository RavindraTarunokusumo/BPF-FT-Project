...
SEC("xdp")
int xdp_transform_rl_v2_conf_ptr_l3_03(struct xdp_md *ctx) {
    ...
    __builtin_memcpy(eth->h_dest, saved_eth.h_dest, ETH_ALEN);
    __builtin_memcpy(eth->h_source, saved_eth.h_source, ETH_ALEN);
